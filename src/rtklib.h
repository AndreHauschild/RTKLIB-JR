...
typedef struct {        /* navigation data type */
    ...
    double osbias[MAXSAT][MAX_CODE_BIAS_FREQS][MAX_CODE_BIASES+1]; /* satellite OSBs (m) */
    double fcbias[MAXSAT][MAX_CODE_BIAS_FREQS][MAX_CODE_BIASES+1]; /* satellite FCBs (m) */
